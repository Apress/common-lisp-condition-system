;;;; clcs-20-choice-1-escape-through-both-doors.lisp

(defpackage #:clcs-20-choice-1-escape-through-both-doors
  (:use #:cl)
  (:export #:test-1 #:test-2 #:test-3 #:test-4))

(in-package #:clcs-20-choice-1-escape-through-both-doors)
...
CL-USER> (clcs-20-choice-1-escape-through-both-doors:test-1)
...
CL-USER> (clcs-20-choice-1-escape-through-both-doors:test-2)
;; Uh oh - Kate's parents are back!
;; The front door is not locked.
...
CL-USER> (clcs-20-choice-1-escape-through-both-doors:test-3)
;; Uh oh - Kate's parents are back!
...
CL-USER> (clcs-20-choice-1-escape-through-both-doors:test-4)
;; The front door is locked.
;; The back door is locked.
