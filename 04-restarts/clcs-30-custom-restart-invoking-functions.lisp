;;;; clcs-30-custom-restart-invoking-functions.lisp
...
CL-USER> (clcs-30-custom-restart-invoking-functions:test-1)
;; Uh oh - Kate's parents are back!
;; Escaping through the back door.
;; Whew... We're safe! For now.
NIL

CL-USER> (clcs-30-custom-restart-invoking-functions:test-2)
;; Uh oh - Kate's parents are back!
;; Escaping through the front door.
;; Whew... We're safe! For now.
NIL

CL-USER> (clcs-30-custom-restart-invoking-functions:test-3)
;; Uh oh - Kate's parents are back!
;; Escaping through the back door.
;; Whew... We're safe! For now.
NIL

CL-USER> (clcs-30-custom-restart-invoking-functions:test-4)
;; Uh oh - Kate's parents are back!
